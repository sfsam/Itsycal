...
- (void)viewDidLoad
{
    ...
    [_moCal bind:@"showLunar" toObject:[NSUserDefaultsController sharedUserDefaultsController] withKeyPath:[@"values." stringByAppendingString:kShowLunarDate] options:@{NSContinuouslyUpdatesValueBindingOption: @(YES)}];
